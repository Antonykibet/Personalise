    ...
    return(
        <div>
            <Stack color='white' direction='column' component='footer' >
                <Stack sx={{backgroundColor:'#3c67d8'}} paddingTop={2} px={2} justifyContent='space-around' direction='row'>
                    ...
                    <Box sx={{display:'flex', justifyContent:'space-around', flexWrap:'wrap',p:1}}  width='65%'>
                        <Stack >
